    ...
    <div className="max-w-[1200px] space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="font-display text-[32px] font-bold text-[#ffffff] leading-[1.1] tracking-[-0.02em]">Learning Roadmap</h1>
        ...
        <button 
          ...
          className="inline-flex items-center gap-2 btn-neo-violet font-mono text-[12px] font-bold uppercase tracking-[0.05em] px-6 py-2.5 rounded-md cursor-pointer disabled:opacity-50"
        >
          {isGenerating ? (
      ...
      {items.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="md:col-span-1 space-y-4">
            <div className="card-console p-5 border-[#1e1e2f]">
            ...
            {items.map((item) => (
              <div 
                ...
                className={`card-console p-5 transition-all ${
                  item.status === 'completed' ? 'border-[#1e1e2f] bg-[#09090e]/80 opacity-75' : 'hover:border-[#3730a3]'
                }`}
              >
                <div className="flex items-start justify-between gap-4 mb-3">
                  <div className="space-y-1.5">
                    <div className="flex items-center gap-2">
                      <span className={`font-mono text-[10px] uppercase rounded-md px-2 py-0.5 font-semibold ${
                        item.priority <= 2
                      ...
                      <span className="font-mono text-[11px] text-[#64748b] uppercase tracking-[0.05em]">{item.topic}</span>
                    </div>
                ...
                <div className="flex flex-wrap items-center gap-4 font-mono text-[11px] text-[#64748b]">
                  ...
                  <div className="flex items-center gap-1">
                    <BookOpen className="h-3 w-3 text-[#818cf8]" />
