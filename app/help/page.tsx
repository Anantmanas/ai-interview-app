    ...
    <main className="min-h-screen bg-[#000000] relative overflow-hidden">
      ...
      <nav className="relative z-10 border-b border-[#1e1e2f] bg-[#000000]/80 backdrop-blur-sm">
        <div className="max-w-[900px] mx-auto px-6 h-14 flex items-center justify-between">
          <Link href="/" className="inline-flex items-center gap-2.5">
            ...
            <span className="font-mono text-[13px] font-bold text-white uppercase tracking-[0.1em]">InterviewAI</span>
          </Link>
          <Link href="/dashboard" className="font-mono text-[11px] text-[#818cf8] hover:text-white uppercase tracking-[0.08em] transition-colors">
            Dashboard →
          </Link>
        </div>
      </nav>
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-6 py-16">
        ...
        <div className="mb-14 text-center">
          <p className="font-mono text-[10px] text-[#818cf8] uppercase tracking-[0.2em] mb-3">// HELP CENTER</p>
          <h1 className="font-display text-[44px] font-bold text-white tracking-[-0.025em] mb-4">
            How can we help?
          </h1>
          <p className="font-body text-[16px] text-[#9ca3af] max-w-[500px] mx-auto">
        ...
        {/* Contact card */}
        <div className="mt-16 p-7 border border-[#1e1e2f] rounded-[8px] bg-[#09090e] text-center shadow-[0_0_50px_rgba(79,70,229,0.06)]">
          <p className="font-mono text-[10px] text-[#818cf8] uppercase tracking-[0.15em] mb-2">// STILL STUCK?</p>
          <h2 className="font-display text-[24px] font-bold text-white mb-2">Contact Support</h2>
          <p className="font-body text-[14px] text-[#9ca3af] mb-5">
            Our team responds within 24 hours on business days.
          </p>
          <a
            href="mailto:support@interviewai.app"
            className="inline-flex items-center gap-2 bg-[#4f46e5] text-white font-mono text-[12px] font-bold uppercase tracking-[0.06em] px-6 py-2.5 rounded-[6px] border border-[#3730a3] hover:bg-[#5865f2] transition-colors shadow-[0_0_20px_rgba(79,70,229,0.35)]"
          >
