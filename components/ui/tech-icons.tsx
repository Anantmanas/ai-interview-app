...
export const TECH_DEFINITIONS: Record<string, TechDefinition> = {
  ...
  postgresql: {
    ...
    path: (
      <g>
        ...
        <path
          d="M12 4.5c-3.8 0-6.8 2.6-7.3 6.1-.2 1.3 0 2.8.6 3.9.7 1.3 2 2.3 3.5 2.7.2.5.5 1 .9 1.4 1 1 2.5 1.5 4 1.4 1.3-.1 2.5-.7 3.3-1.7.9-1.1 1.3-2.6 1.2-4.1-.1-2.4-1.6-4.6-3.8-5.5-.8-.3-1.6-.4-2.4-.2z"
          fill="#FFFFFF"
          opacity="0.95"
        />
      </g>
  ...
  svelte: {
    ...
    path: (
      <path
        d="M18.8 4.2C16.9 1.7 13.5 1 10.6 2.5L5.7 5.7C4.1 6.7 3.2 8.4 3.2 10.3c0 1.2.4 2.4 1.2 3.4-.4.8-.6 1.7-.6 2.6 0 2.8 1.8 5.2 4.4 6 1.2.4 2.5.3 3.6-.3l4.9-3.2c1.6-1 2.5-2.8 2.5-4.6 0-1.2-.4-2.4-1.2-3.4.4-.8.6-1.7.6-2.6.1-1.6-.7-3.1-1.8-4z"
        fill="#FF3E00"
      />
    ),
  },
  flutter: {
    ...
    path: (
      <path
        d="M14.3 2.5L3.5 13.3l3.3 3.3L20.9 2.5h-6.6zm0 9.8l-5 5 5 5h6.6l-8.3-8.3 1.7-1.7z"
        fill="#02569B"
      />
    ),
  },
  swift: {
    ...
    path: (
      <path
        d="M20.9 17.5c-3.1 3.5-8.1 4.7-12.2 3.1 4.2-1.2 7.5-4.2 8.7-8.3-2.6 2-5.9 2.9-9.1 2.4 3.5-2 6.1-5.4 6.8-9.4C10.7 7.7 6.4 12 3 17.2c3.4-3.5 8.1-5.3 13-4.8-1.5 1.5-3.3 2.7-5.3 3.5 3.3-.3 6.4-1.6 8.8-3.7.5 1.8.8 3.6.4 5.3z"
        fill="#F05138"
      />
    ),
  },
  kotlin: {
    ...
    path: (
      <path
        d="M22 2H2v20h20L12 12l10-10zM2 12l10 10H2V12z"
        fill="#7F52FF"
      />
    ),
  },
  django: {
    ...
    path: (
      <g>
        ...
        <path
          d="M13.2 5.5h2.4v9.8c-.4.2-1 .3-1.6.3-2.2 0-3.3-1.2-3.3-3.2 0-2.1 1.2-3.4 3.3-3.4.5 0 .9.1 1.2.2V5.5zm0 5.4c-.2-.1-.5-.1-.7-.1-1.1 0-1.7.7-1.7 1.8 0 1.1.5 1.7 1.6 1.7.3 0 .6 0 .8-.1V10.9zM7.2 9.2h2.4v9.3H7.2V9.2zm0-3.7h2.4v2.4H7.2V5.5z"
          fill="#FFFFFF"
        />
      </g>
    ),
  ...
  spring: {
    ...
    path: (
      <path
        d="M21.5 10.2c-1.8-6.1-8.3-8.8-14.4-7-5.9 1.7-8.8 8.1-7 14.1 1.7 5.6 7.4 8.7 13.1 7.4l-.8-2.6c-4.4 1-8.8-1.4-10.1-5.7-1.4-4.6.8-9.5 5.4-10.8 4.7-1.4 9.6.9 11 5.6.8 2.6.3 5.4-1.3 7.5l2.2 1.6c2.2-2.8 2.8-6.5 1.9-10.1z"
        fill="#6DB33F"
      />
    ),
  },
  linux: {
    ...
    path: (
      <path
        d="M12 2C9.5 2 8.5 4.5 8.5 6.5c0 1.5.5 3 .5 4.5C8 12 6.5 13 6.5 15.5c0 3 2.5 5.5 5.5 5.5s5.5-2.5 5.5-5.5c0-2.5-1.5-3.5-2.5-4.5 0-1.5.5-3 .5-4.5C15.5 4.5 14.5 2 12 2z"
        fill="#FCC624"
      />
    ),
  },
  figma: {
    ...
    path: (
      <g>
        ...
        <path d="M8 12h4v5a2.5 2.5 0 0 1-4-2.5V12z" fill="#0ACF83" />
      </g>
    ),
  },
}
...
export function normalizeTechName(name: string): string {
  ...
  if (s.includes('python') || s.includes('flask') || s.includes('fastapi')) return 'python'
  ...
  if (s.includes('spring') || s.includes('springboot')) return 'spring'
  ...
  if (s.includes('swift') || s.includes('ios')) return 'swift'
  if (s.includes('kotlin') || s.includes('android')) return 'kotlin'
...
export function TechIcon({
  ...
  return (
    <svg
      ...
      className={`shrink-0 inline-block align-middle transition-transform duration-200 group-hover:scale-110 ${className}`}
