  ...
  return (
    <div aria-hidden="true" className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
      ...
      <motion.div
        ...
        style={{
          background: 'radial-gradient(ellipse at center, rgba(113,208,131,0.08) 0%, transparent 70%)',
        }}
      ...
      <motion.div
        ...
        style={{
          background: 'radial-gradient(ellipse at center, rgba(186,167,255,0.06) 0%, transparent 70%)',
        }}
